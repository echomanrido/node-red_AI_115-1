    ...
    "applications": [
      {
        "scenario": "機電整合丙級",
        "icon": "fa-solid fa-gears",
        "description": "在丙級術科 SCADA 整合中，可利用此處相同的 HTTP Request 與 OAuth 2.0 驗證通訊機制連接工廠中央的 MES 生產工單伺服器。藉由取得授權 Token 載入最新派工指令 JSON 數據，並將加工參數（如生產配方）寫入三菱 PLC，實作現場端與資訊層的動態安全連線。"
      },
      {
        "scenario": "台積電工業務聯網",
        "icon": "fa-solid fa-microchip",
